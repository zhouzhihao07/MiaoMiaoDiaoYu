...
/**
 * Created by zhouzhihao on 2016/7/4 0004.
 */
public class LoadMoreRecycler extends RecyclerView{
    int oldBottomPosition=-2;
    int newBottomPosition=-1;
    ...
    public class AutoLoadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public class FooterViewHolder extends RecyclerView.ViewHolder {
            ...
            public FooterViewHolder(View itemView) {
                super(itemView);
                tv= (TextView) itemView.findViewById(R.id.loadmore);
            }
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (type != TYPE_FOOTER && type != TYPE_HEADER) {
                ...
                newBottomPosition=mLoadMorePosition;
//                Log.i("old",oldBottomPosition+"new"+newBottomPosition);
//                Log.i("new",newBottomPosition+"");
                if(newBottomPosition==oldBottomPosition){
                    ((FooterViewHolder)holder).tv.setText("别拉了，亲，是真的没有了！");
                }
            }
        }
...
//        getLayoutManager().removeAllViews();
    ...
    public void notifyMoreFinish(boolean hasMore) {
        ...
        oldBottomPosition=newBottomPosition;
    }
}
